                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-xs flex-wrap" style={{ color: '#6B7280' }}>
                      ...
                      <ExpiryUrgency daysRemaining={cert.days_remaining} status={cert.status} />
                    </div>
                    {cert.status === 'revoked' && cert.revocation_reason && (
                      <div className="mt-2 px-3 py-2 rounded-lg text-xs"
                        style={{ background: 'rgba(220,38,38,0.06)', border: '1px solid rgba(220,38,38,0.2)', color: '#7f1d1d' }}
                        data-revocation>
                        <strong>Lý do thu hồi:</strong> {cert.revocation_reason}
                        {cert.revoked_at && (
                          <span className="block mt-0.5 text-[11px]" style={{ color: '#991b1b' }}>
