        ...
        <div className="text-center animate-scale-in max-w-md px-6">
          ...
          <div className="mt-6 pt-4" style={{ borderTop: "1px solid #E2E8F0" }}>
            <p className="text-xs" style={{ color: "#94A3B8" }}>
              Powered by AMINRA · Halal Supply Chain Integrity
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen" style={{ background: "#F5F1E8" }} data-page>
      ...
      <div className="max-w-2xl mx-auto px-5 -mt-4 pb-12 space-y-4">
        {/* Progress + Score card */}
        <div
          className="rounded-2xl p-5 animate-section"
          style={{
            background: "#FFFFFF",
        ...
        >
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="flex items-end gap-2 mb-2">
                ...
                <span className="text-xs pb-1" style={{ color: "#94A3B8" }}>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    background:
                      progress.percent === 100 ? "#0A1F44" : "#F59E0B",
                  }}
                />
              </div>
            </div>
                  ...
                  <div className="relative w-14 h-14">
                    ...
                    >
                      ...
                      <circle
                        ...
                        stroke={
                          batch.compliance_score >= 75
                            ? "#0A1F44"
                            : batch.compliance_score >= 50
                              ? "#F59E0B"
                              : "#EF4444"
                        }
                        strokeWidth="3"
          ...
          >
            <div>
              ...
              <p className="text-xs font-medium" style={{ color: "#0A1F44" }}>
                {formatDate(batch.started_at) || "Chưa bắt đầu"}
              </p>
            </div>
            <div>
              <p className="text-xs" style={{ color: "#94A3B8" }}>
              ...
              <p className="text-xs font-medium" style={{ color: "#0A1F44" }}>
                {formatDate(batch.completed_at) || "Chưa hoàn thành"}
              </p>
            </div>
          </div>
        </div>
        ...
        {integrity && (
          <div
            className={`rounded-2xl p-5 animate-section ${integrity.verified ? "" : ""}`}
            style={{
              background: integrity.verified
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h3
                  ...
                  style={{ color: integrity.verified ? "#0A1F44" : "#DC2626" }}
                >
                  {integrity.verified
                    ? "Dữ liệu toàn vẹn — Đã xác minh"
                    : "Cảnh báo: Dữ liệu có thể bị thay đổi"}
                </h3>
                <p
                  className="text-xs mt-1"
                  style={{ color: integrity.verified ? "#047857" : "#B91C1C" }}
                >
                  {integrity.verified
            ...
            <div className="divide-y" style={{ borderColor: "#F0F0F0" }}>
              {steps.map((step, i) => {
                ...
                return (
                  <div
                    key={i}
                    className={`px-5 py-3.5 flex items-start gap-3 animate-list-item stagger-${Math.min(i + 1, 12)}`}
                  >
                    {/* Step indicator */}
                    <div
                      className={`w-7 h-7 rounded-full grid place-items-center flex-shrink-0 mt-0.5 ${done ? "" : ""}`}
                      style={{
                    ...
                    <div className="flex-1 min-w-0">
                      <p
                        ...
                        style={{ color: done ? "#0A1F44" : "#94A3B8" }}
                      >
                        {step.name}
                      </p>
            ...
            <div className="divide-y" style={{ borderColor: "#F0F0F0" }}>
              {materials.map((mat, i) => {
                ...
                return (
                  <div
                    key={i}
                    className={`px-5 py-3.5 animate-list-item stagger-${Math.min(i + 1, 12)}`}
                  >
        ...
        {certificates.length > 0 && (
          ...
          >
            ...
            >
              <h2 className="text-sm font-bold" style={{ color: "#0A1F44" }}>
                Chứng chỉ nhà cung cấp
              </h2>
            </div>
            <div className="divide-y" style={{ borderColor: "#F0F0F0" }}>
              {certificates.map((cert, i) => {
                const expired = cert.expiry_date
        ...
        <div className="pt-6 pb-4 text-center animate-section">
          ...
          <p className="text-xs mt-1" style={{ color: "#CBD5E1" }}>
            Thông tin được cung cấp bởi doanh nghiệp sản xuất và xác minh bởi hệ
            thống AMINRA
          </p>
        </div>
      </div>
