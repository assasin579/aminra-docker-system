  ...
  return (
    <div className="w-full max-w-md" data-page>
      ...
      <div className="text-center mb-8 animate-section">
        ...
        <h1 className="text-2xl font-bold" style={{ color: '#1A2332' }}>Cổng dành cho tổ chức</h1>
      ...
      <div className="rounded-2xl p-8 animate-section" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
        ...
        <div className="grid items-center gap-2 mb-6 px-3 py-2 rounded-lg"
          style={{ gridTemplateColumns: 'auto 1fr', background: 'rgba(100,116,139,0.08)', border: '1px solid rgba(100,116,139,0.2)' }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-xs font-medium mb-1.5" style={{ color: '#5F6F80' }}>Email tổ chức</label>
            <input
        ...
        <div className="mt-6 pt-5 text-center" style={{ borderTop: '1px solid #E2E8F0' }}>
          <p className="text-sm" style={{ color: '#5F6F80' }}>
            Chưa đăng ký?{' '}
            <Link href="/provider/register" className="font-medium hover:opacity-80 transition-opacity" style={{ color: '#087653' }}>
              Đăng ký tổ chức
            </Link>
          </p>
        </div>
      ...
      <p className="text-center mt-6 text-xs" style={{ color: '#94A3B8' }}>
        ...
        <Link href="/business/login" className="transition-colors" style={{ color: '#5F6F80' }}>
          Đăng nhập tại đây
        </Link>
      </p>
    </div>
