    ...
    <div className="w-full max-w-md" data-page>
      ...
      <div className="rounded-2xl p-8 animate-section" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-xs font-medium mb-1.5" style={{ color: '#6B7280' }}>Email tổ chức</label>
            <input
        ...
        <div className="mt-6 pt-5 text-center" style={{ borderTop: '1px solid #E2E8F0' }}>
          <p className="text-sm" style={{ color: '#6B7280' }}>
            Chưa đăng ký?{' '}
            <Link href="/provider/register" className="inline-flex items-center min-h-[32px] font-medium hover:opacity-80 transition-opacity" style={{ color: '#0F5132' }}>
              Đăng ký tổ chức
            </Link>
          </p>
        </div>
      ...
      <p className="text-center mt-6 text-xs" style={{ color: '#94A3B8' }}>
        ...
        <Link href="/business/login" className="inline-flex items-center min-h-[32px] transition-colors" style={{ color: '#6B7280' }}>
          Đăng nhập tại đây
        </Link>
      </p>
    </div>
