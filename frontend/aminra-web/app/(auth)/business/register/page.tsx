 ...
 * Redirect to Keycloak SSO login page, where user clicks "Đăng ký ngay"
 * (themed link) to access the Keycloak registration form.
 */
...
export default function BusinessRegisterPage() {
  useEffect(() => {
    void signinRedirect("/dashboard/business");
  }, []);
    ...
    <div className="w-full max-w-md text-center" data-page>
      ...
      >
        ...
        <p className="text-sm mt-2" style={{ color: "#6B7280" }}>
          Tại trang đăng nhập Keycloak, bấm <b>"Đăng ký ngay"</b> để tạo tài khoản doanh nghiệp mới.
        </p>
      </div>
    </div>
  );
