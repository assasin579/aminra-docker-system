...
export default function HomePage() {
  ...
  const loadVoices = () => {
    ...
    if (matched.length > 0) {
      setSelectedVoiceName((prev) =>
        matched.find((v) => v.name === prev) ? prev : matched[0].name,
      );
    }
  };
  ...
  const whyItems = [
    ...
    },
    {
      ...
      titleKey: "home.why5_title",
      descKey: "home.why5_desc",
      color: "#102A5C",
    ...
    },
    {
      ...
      titleKey: "home.why6_title",
      descKey: "home.why6_desc",
      color: "#06b6d4",
  ...
  return (
    <div className="flex flex-col flex-1 lg:min-h-0 w-full" data-page>
      ...
      <div className="flex flex-col lg:flex-row gap-4 flex-1 lg:min-h-0">
        {/* Chat Container */}
        <div
          className="flex-1 lg:min-h-0 rounded-2xl shadow-xl overflow-hidden flex flex-col"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="relative flex-shrink-0">
                  <div
                    className="h-11 w-11 rounded-full overflow-hidden ring-2 ring-[#0A1F44]/50"
                    style={{
                  ...
                  >
                    ...
                    >
                      ...
                      <path
                        d="M26 60 Q18 78 20 100 L50 90 L80 100 Q82 78 74 60 Q63 70 50 70 Q37 70 26 60Z"
                        fill="#c8607a"
                      />
                      ...
                      {/* White forehead band */}
                      <path
                        d="M27 19 Q50 9 73 19 Q73 27 50 29 Q27 27 27 19Z"
                        fill="white"
                      />
                      {/* Face */}
                      ...
                      <path
                        d="M38 54 Q50 65 62 54 Q50 58 38 54Z"
                        fill="#c0392b"
                      />
                      <path
                        d="M39 54.5 Q50 60 61 54.5 Q50 56.5 39 54.5Z"
                        fill="white"
                      />
                      {/* Buttons on coat */}
                  ...
                  <div
                    className="absolute bottom-0 right-0 h-3 w-3 rounded-full bg-[#0A1F44]"
                    style={{
              ...
              {availableVoices.length > 1 && (
                <div className="relative">
                  ...
                  {showVoicePicker && (
                    <div
                      className="absolute right-0 top-full mt-1 z-50 rounded-xl shadow-xl overflow-hidden min-w-[220px]"
                      style={{
                        background: "#FFFFFF",
                        border: "1px solid #E2E8F0",
                      }}
        ...
        `}</style>
          ...
          {/* Messages Area */}
          <div
            className="relative flex-1 lg:min-h-0 min-h-[300px] flex flex-col"
          ...
          >
                  ...
                  <div
                    ...
                    style={
                      msg.sender === "user"
                        ...
                        : {
                            background:
                              speakingId === msg.id ? "#DCE3F0" : "#F5F1E8",
                            border: `1px solid ${speakingId === msg.id ? "#0A1F44" : "#E2E8F0"}`,
                            color: "#0A1F44",
                          }
                    }
                  >
            ...
            >
              <div className="flex items-end gap-3">
                <div className="flex-1 relative">
                  <textarea
                    ...
                    style={{
                      background: "#FFFFFF",
                      border: `1px solid ${isListening ? "#0A1F44" : "#E2E8F0"}`,
                      color: "#0A1F44",
                    }}
                    placeholder={
                      isListening
                ...
                <div className="flex flex-col gap-2">
                  {voiceSupported && (
                    <button
                      ...
                      disabled={loading}
                      title={
                        isListening ? "Dừng ghi âm" : "Nhận diện giọng nói"
                      }
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {(["preset1", "preset2", "preset3", "preset4"] as const).map(
                  (key) => (
                    <button
                      key={key}
        ...
        {/* Why Choose Aminra */}
        <div
          className="lg:w-80 rounded-2xl overflow-hidden flex flex-col lg:min-h-0"
          style={{ background: "#FFFFFF", border: "1px solid #E2E8F0" }}
        >
