...
export default function ConfirmDeletionPage() {
  ...
  const onConfirm = async () => {
    ...
    try {
      ...
      ['aminra_user_token', 'aminra_user_profile', 'aminra_admin_token']
  ...
  return (
    <article className="max-w-xl mx-auto px-6 py-12" data-page>
      ...
      {done ? (
        ...
        <>
          <div className="bg-red-50 border border-red-200 rounded-2xl p-5 mb-6 text-sm" style={{ color: '#7f1d1d' }}>
            <p className="font-semibold mb-2">Bạn đang xác nhận xoá tài khoản AMINRA của mình.</p>
            <p>Hành động này <strong>không thể khôi phục</strong>. Khi xác nhận:</p>
          ...
          {error && (
            <div role="alert" className="mt-4 bg-red-100 border border-red-300 rounded-lg p-3 text-sm"
              style={{ color: '#991b1b' }}>
              {error}
            </div>
          )}
