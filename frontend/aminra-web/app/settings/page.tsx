  ...
  return (
    <div data-page style={{ background: '#FFFFFF' }}>
      <div className="max-w-xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="rounded-2xl p-6 mb-6 animate-section" style={{ background: '#F5F1E8', border: '1px solid #E2E8F0' }}>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl grid place-items-center" style={{ background: 'rgba(10,31,68,0.12)', border: '1px solid rgba(10,31,68,0.25)' }}>
            ...
            <div>
              <h1 className="text-xl font-bold" style={{ color: '#0A1F44' }}>Cài đặt tài khoản</h1>
        ...
        {isOwner && (
          <div className="animate-section rounded-2xl p-6 doc-card-hover" style={cardStyle}>
            <h2 className="text-sm font-semibold mb-4" style={{ color: '#0A1F44' }}>Logo công ty</h2>
        ...
        <div className="animate-section rounded-2xl p-6 space-y-4 doc-card-hover" style={cardStyle}>
          <h2 className="text-sm font-semibold" style={{ color: '#0A1F44' }}>Đổi mật khẩu</h2>
          <div>
          ...
          {pwMsg && (
            <div className="px-3 py-2 rounded-lg text-xs animate-toast"
              style={pwMsg.type === 'ok'
                ? { background: '#DCE3F0', border: '1px solid #D9B96E', color: '#102A5C' }
          ...
          <button onClick={handleChangePassword} disabled={pwSaving || !pwForm.current || !pwForm.newPw || !pwForm.confirm}
            ...
            style={{ background: (!pwForm.current || !pwForm.newPw || !pwForm.confirm) ? '#E2E8F0' : '#0A1F44',
        ...
        {/* ── Thông báo ── */}
        <div className="animate-section rounded-2xl p-6 space-y-4 doc-card-hover" style={cardStyle}>
          <h2 className="text-sm font-semibold" style={{ color: '#0A1F44' }}>Thông báo</h2>
          {[
            ...
            <div key={item.key} className="flex items-center justify-between gap-3 px-4 py-3 rounded-xl"
              ...
              <div>
                <p className="text-sm font-medium" style={{ color: '#0A1F44' }}>{item.label}</p>
          ...
          {notifSaved && (
            <div className="px-3 py-2 rounded-lg text-xs animate-toast" style={{ background: '#DCE3F0', border: '1px solid #D9B96E', color: '#102A5C' }}>Đã lưu</div>
          )}
        ...
        <div className="rounded-2xl p-5 space-y-3" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0' }}>
          <h2 className="text-lg font-bold" style={{ color: '#0A1F44' }}>Quyền dữ liệu cá nhân</h2>
