  ...
  return (
    <article className="max-w-3xl mx-auto px-6 py-10" data-page>
      ...
      <p className="text-sm mb-6" style={{ color: '#6B7280' }}>
        Theo Nghị định 13/2023/NĐ-CP (Việt Nam) và GDPR Article 20 (EU), bạn có quyền yêu
        cầu một bản sao toàn bộ dữ liệu cá nhân chúng tôi đang lưu trữ về bạn ở định dạng
        máy đọc được (JSON).
      </p>
      ...
      <section className="bg-white rounded-2xl p-6 mb-6" style={{ border: '1px solid #E2E8F0' }}>
        ...
        <p className="text-xs mt-4" style={{ color: '#94A3B8' }}>
          Mật khẩu (đã hash) và secrets không được bao gồm. Audit log có thể được giữ vượt
          quá thời điểm xoá tài khoản theo nghĩa vụ pháp lý (tối thiểu 5 năm).
        </p>
      </section>
      ...
      {error && (
        <div role="alert" className="mt-4 bg-red-50 border border-red-200 rounded-lg p-3 text-sm"
          style={{ color: '#991b1b' }}>
          {error}
        </div>
      )}
      ...
      <p className="text-xs mt-6" style={{ color: '#94A3B8' }}>
        Yêu cầu giới hạn 3 lần / giờ. Mỗi lần xuất được ghi lại trong audit log để bảo mật.
      </p>
  ...
  return (
    <section className="mt-12 pt-8 border-t" style={{ borderColor: '#E2E8F0' }}>
      ...
      <p className="text-xs mb-4" style={{ color: '#6B7280' }}>
        Theo Nghị định 13 / GDPR Article 17, bạn có quyền yêu cầu xoá tài khoản. Chúng tôi
        sẽ gửi email xác nhận trước khi thực hiện. Hành động này không thể khôi phục.
      </p>
