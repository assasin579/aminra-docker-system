...
function buildEndSessionUrl(idTokenHint?: string | null): string {
  const authority =
...
export function _buildEndSessionUrlForTests(idTokenHint?: string | null): string {
  return buildEndSessionUrl(idTokenHint);
}
