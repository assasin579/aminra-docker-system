...
describe('PrivacyPage', () => {
  ...
  test('contains all 10 mandated PDPL-aligned sections', () => {
    ...
    [
      ...
      expect(screen.getByRole('heading', { level: 2, name: new RegExp(section) })).toBeInTheDocument();
    });
  });
...
describe('TermsPage', () => {
  ...
  test('clarifies AMINRA does NOT directly issue Halal certificates', () => {
    ...
    expect(container.textContent).toMatch(/AMINRA\s+không\s+trực tiếp cấp chứng nhận/i);
  });
