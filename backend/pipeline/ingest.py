...
TOPIC_KEYWORDS = {
    ...
    "audit_team": ["lead auditor", "auditor", "auditee", "trưởng đoàn đánh giá", "đánh giá viên", "được đánh giá"],
    "halal_standard": ["jakim", "ms1500", "mhms", "mhcmp", "halal assurance", "tiêu chuẩn halal", "đảm bảo halal"],
    "non_conformance": ["non-conformance", "ncr", "corrective action", "car", "không phù hợp", "hành động khắc phục"],
    "documentation": [
        "document",
        "record",
        "evidence",
    ...
    "certification_body": ["jakim", "mui", "muis", "esma", "sfda", "hdc", "cơ quan chứng nhận"],
    "logistics": [
        "logistics",
        "cold chain",
        "labelling",
